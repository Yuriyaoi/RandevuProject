...
public class MapActivity extends AppCompatActivity
    ...
    public void onMyLocationClick(@NonNull Location location) {
        try {
            ...
            Location dest = new Location(createNewLocation(13.722,100.21));

            //Toast.makeText(this, "Current location:\n" + "Latitude: " + lat + "\nLongitude: " + lon, Toast.LENGTH_LONG).show();
            Toast.makeText(this, "the fuck>>", Toast.LENGTH_LONG).show();
            DateTime now = new DateTime();
            DirectionsResult result = DirectionsApi.newRequest(getGeoContext())
                    .mode(TravelMode.DRIVING).origin(location.toString())
                    .destination(dest.toString()).departureTime(now).await();

                //Toast.makeText(this, "the fuck>>", Toast.LENGTH_LONG).show();
                //Toast.makeText(this, getEndLocationTitle(result), Toast.LENGTH_LONG).show();
